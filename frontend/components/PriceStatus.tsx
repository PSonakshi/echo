...
export default function PriceStatus({ price, divergence = "neutral" }: Props) {
  ...
  return (
    <div className="glass-panel rounded-2xl p-6 h-full flex flex-col justify-center">
      ...
      <div className="space-y-5">
        <div>
          <div className="text-xs text-foreground/60 mb-2 uppercase tracking-widest">Current</div>
          <div className="text-4xl md:text-5xl font-bold text-foreground">${price.toFixed(0)}</div>
        </div>
